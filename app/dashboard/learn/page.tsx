...
<div className="w-1/2 bg-gray-300 rounded-xl h-4 mt-5">
  ...
  />
</div>        <p className='text-sm text-gray-500'>{currentPage+1}/{content.length}</p>
  ...
  <div className="w-full flex flex-col items-center gap-4">
    ...
    <Button
      onClick={async()=>{
        if(!userName.trim()) return toast.error('Please enter your name to download the certificate')
        ...
        link.href=defaultURL
          link.download = `${userName || 'Certificate'}_NextJS.png`
        link.click()
